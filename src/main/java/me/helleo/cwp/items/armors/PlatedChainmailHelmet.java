...
public class PlatedChainmailHelmet extends BaseArmor {
    ...
    public ItemStack getArmorPiece() {
        ...
        modifiers.put(Attribute.ARMOR,new AttributeModifier(NamespacedKey.fromString("generic.plated_chainmail_helmet.armor"), def,
    ...
    public static void setArmorPieceRecipe(){
        Bukkit.addRecipe(new PlatedChainmailHelmet().getArmorPieceRecipe());
    }
}
