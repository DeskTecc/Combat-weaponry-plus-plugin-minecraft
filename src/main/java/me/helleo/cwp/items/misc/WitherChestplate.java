...
public class WitherChestplate {
    ...
    public ItemStack getArmorPiece(){
        ...
        if (ConfigurationsBool.UseCustomValues.getValue()) {
            kbr = ConfigurationsDouble.Armors_WitherChestplate_KBResist.getValue() / 10;
            hp = ConfigurationsDouble.Armors_WitherChestplate_BonusHealth.getValue();
        }
    ...
    public ShapedRecipe getArmorRecipe(){
        NamespacedKey key = new NamespacedKey(CombatWeaponryPlus.getPlugin(), "wither_bone_chestplate");
    ...
    public static void setArmorRecipe(){
        Bukkit.addRecipe(new WitherChestplate().getArmorRecipe());
    }
}
