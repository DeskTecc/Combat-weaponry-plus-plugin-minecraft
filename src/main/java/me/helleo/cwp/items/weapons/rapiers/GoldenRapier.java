...
public class GoldenRapier extends BaseRapier{
    ...
    public ItemStack getRapier() {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionGoldenRapier_Line9.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionGoldenRapier_Line10.getValue()));
        meta.setLore(lore);
        //important:
        ...
        if (ConfigurationsBool.UseCustomValues.getValue()) {
            dmg = ConfigurationsDouble.Rapiers_GoldenRapier_Damage.getValue();
            spd = ConfigurationsDouble.Rapiers_GoldenRapier_Speed.getValue();
        }
