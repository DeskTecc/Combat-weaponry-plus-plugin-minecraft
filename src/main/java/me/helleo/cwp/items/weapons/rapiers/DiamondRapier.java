...
public class DiamondRapier extends BaseRapier{
    ...
    static String rapierPath = "DiamondRapier";
    ...
    public static ItemStack getRapier() {
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', description.DiamondRapier.getValue()));
    ...
    public static void setRapierRecipe(){
        Bukkit.addRecipe(getWeaponRecipe("rapier","diamond_rapier",getRapier(),Material.DIAMOND));
    }
}
