...
public class NetheriteKnife extends BaseKnife{
    ...
    public ItemStack getKnife() {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionNetheriteKnife_Line7.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionNetheriteKnife_Line8.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionNetheriteKnife_Line9.getValue()));
        meta.setLore(lore);
        //important:
        ...
        if (ConfigurationsBool.UseCustomValues.getValue()) {
            dmg = ConfigurationsDouble.Knives_NetheriteKnife_Damage.getValue();
            spd = ConfigurationsDouble.Knives_NetheriteKnife_Speed.getValue();
        }
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionNetheriteKnife_Name.getValue()));
