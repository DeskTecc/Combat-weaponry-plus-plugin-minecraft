...
public class StoneCleaver extends BaseCleaver{
    ...
    public ItemStack getCleaver() {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionStoneCleaver_Line10.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionStoneCleaver_Line11.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionStoneCleaver_Line12.getValue()));
        meta.setLore(lore);
        //important:
        ...
        if (ConfigurationsBool.UseCustomValues.getValue()) {
            dmg = ConfigurationsDouble.Cleavers_StoneCleaver_Damage.getValue();
            spd = ConfigurationsDouble.Cleavers_StoneCleaver_Speed.getValue();
        }
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionStoneCleaver_Name.getValue()));
