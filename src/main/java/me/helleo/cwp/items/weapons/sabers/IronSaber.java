...
public class IronSaber extends BaseSaber{
    ...
    public ItemStack getSaber() {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionIronSaber_Line5.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionIronSaber_Line6.getValue()));
        lore.add(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionIronSaber_Line7.getValue()));
        meta.setLore(lore);
        //important:
        ...
        if (ConfigurationsBool.UseCustomValues.getValue()) {
            dmg = ConfigurationsDouble.Sabers_IronSaber_Damage.getValue();
            spd = ConfigurationsDouble.Sabers_IronSaber_Speed.getValue();
        }
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', ConfigurationsString.DescriptionIronSaber_Name.getValue()));
